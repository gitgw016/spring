...
public class PrintLogFilter implements Filter{
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		System.out.println("PrintLogFilter init 왔다");
		filePath = filterConfig.getInitParameter("filePath");
		System.out.println("filePath : "+filePath);
		System.out.println("PrintLogFilter init 갔다");
	}

	@Override
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
			throws IOException, ServletException {
		System.out.println("PrintLogFilter doFilter 왔다");
		String realPath = request.getServletContext().getRealPath(filePath);
		String rootPath = request.getServletContext().getRealPath("/log");
		...
		System.out.println("PrintLogFilter doFilter 갔다");
	}
