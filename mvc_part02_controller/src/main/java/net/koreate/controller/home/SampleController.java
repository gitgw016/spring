...
public class SampleController {
	...
	public void product(Model model) {
		...
		model.addAttribute(productVO2); // == model.addAttribute("productVO",productVO2);
	}
	...
	public ModelAndView productWrite(ModelAndView mav, String name, int price, ProductVO product) {
